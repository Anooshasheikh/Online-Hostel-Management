...
<div class="inner-page-banner" id="home"> 	   
    ...
    <?php 
        ...
        if (isset($_SESSION['username']) && !empty($_SESSION['username'])) {
            ...
            // If not set, show a default text or redirect user
            echo "Guest"; // Or any default text you want
            // Alternatively, you could redirect to the login page like this:
...
<section class="contact py-5">
    ...
    required="">
							...
							<div class="contact-fields-w3ls">
    <input type="text" name="name" placeholder="Name" value="<?php echo isset($_SESSION['username']) ? $_SESSION['username'] : ''; ?>" required="">
</div>
